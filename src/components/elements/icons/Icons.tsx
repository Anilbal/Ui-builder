...
export const NextJsIcon: React.FC<IconProps> = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2Zm0 18c-4.41 0-8-3.59-8-8 0-1.48.4-2.86 1.1-4.05l9.9 11.95V18h-3Zm5.1-3.1L7.15 5.05c.03 0 .05-.01.08-.01.42 0 .83.04 1.23.11l9.54 11.49c-.29.11-.59.2-.9.26ZM15 15l-3-3.6V15h3Z" />
  </svg>
);
